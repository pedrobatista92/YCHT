...
SendMessagesEntry::SendMessagesEntry(QWidget *parent) : QFrame(parent),
                                                        ...
                                                        model(0)
{
    ...
    ui->sendTo->setPlaceholderText(tr("Enter an YCHT address (e.g. F96m4dNBqCLh7ZYceQnLG7uPuva5mochZK)"));
