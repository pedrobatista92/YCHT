 ...
 * The Condensation Chefs 2011-2012
 */
...
ActiveLabel::ActiveLabel(const QString &text, QWidget *parent) : QLabel(parent) {}
...
{
    resize(850, 550);
    setWindowTitle(tr("YCHT") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to an YCHT address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About YCHT"), this);
    aboutAction->setToolTip(tr("Show information about YCHT"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for YCHT"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        if (clientModel->isTestNet())
        {
            ...
            if (trayIcon)
            {
                trayIcon->setToolTip(tr("YCHT client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("YCHT client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to YCHT network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if (event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid YCHT address or malformed URI parameters."));
    }
