        ...
        }
        {
            ...
            BOOST_FOREACH (CNode *pnode, vNodes)
            {
                    ...
                    continue;
                {
                    ...
                    if (lockSend)
                    {
                        // do not read, if dYCHTing write queue
...
void ThreadMapPort2(void *parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "YCHT " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"pok.cash1", "seed1.YCHT.trade"},
    {"pok.cash2", "seed2.YCHT.trade"},
    {"pok.cash3", "seed3.YCHT.trade"},
    {"pok.cash4", "seed4.YCHT.trade"},
};

void ThreadDNSAddressSeed(void *parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("YCHT-dnsseed");
...
bool BindListenPort(const CService &addrBind, string &strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr *)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. YCHT is probably already running."), addrBind.ToString().c_str());
        else
