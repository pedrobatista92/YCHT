...
class Ui_CoinControlDialog
{
  public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 YCHT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 YCHT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 YCHT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 YCHT"));
        ...
        horizontalLayoutWidget->setGeometry(QRect(10, 0, 781, 63));
        ...
        pushButtonSelectAll->setStyleSheet(QStringLiteral(""));
