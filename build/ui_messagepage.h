...
class Ui_MessagePage
{
      public:
        ...
        void setupUi(QWidget *MessagePage)
        {
                ...
                MessagePage->setStyleSheet(QStringLiteral(""));
                ...
                listConversation->setStyleSheet(QStringLiteral(""));
                ...
                messageEdit->setStyleSheet(QStringLiteral(""));
                ...
                copyFromAddressButton->setAutoFillBackground(true);
                copyFromAddressButton->setStyleSheet(QStringLiteral(""));
                QIcon icon3;
                ...
                copyToAddressButton->setStyleSheet(QStringLiteral(""));
...
#ifndef QT_NO_TOOLTIP
                sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own an YCHT address", 0));
#endif // QT_NO_TOOLTIP
