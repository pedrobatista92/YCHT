...
class Ui_AddressBookPage
{
      public:
        ...
        void setupUi(QWidget *AddressBookPage)
        {
                ...
                AddressBookPage->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
                ...
                copyToClipboard->setStyleSheet(QStringLiteral(""));
                QIcon icon1;
                ...
                showQRCode->setStyleSheet(QStringLiteral(""));
                QIcon icon2;
                ...
                signMessage->setStyleSheet(QStringLiteral(""));
                QIcon icon3;
                ...
                verifyMessage->setStyleSheet(QStringLiteral(""));
                QIcon icon4;
        ...
        void retranslateUi(QWidget *AddressBookPage)
        {
                ...
                labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your YCHT addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0));
...
#ifndef QT_NO_TOOLTIP
                signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own an YCHT address", 0));
#endif // QT_NO_TOOLTIP
                signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0));
#ifndef QT_NO_TOOLTIP
                verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified YCHT address", 0));
#endif // QT_NO_TOOLTIP
