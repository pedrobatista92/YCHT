...
class Ui_RPCConsole
{
      public:
        ...
        void setupUi(QDialog *RPCConsole)
        {
                ...
                openDebugLogfileButton->setStyleSheet(QStringLiteral(""));
                ...
                showCLOptionsButton->setStyleSheet(QStringLiteral(""));
                ...
                messagesWidget->setStyleSheet(QStringLiteral(""));
                ...
                trafficGraph->setStyleSheet(QStringLiteral(""));
                ...
                btnClearTrafficGraph->setStyleSheet(QStringLiteral(""));
        ...
        {
                RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "YCHT - Debug window", 0));
                label_9->setText(QApplication::translate("RPCConsole", "YCHT Core", 0));
                ...
                openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the YCHT debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
                showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the YCHT-qt help message to get a list with possible YCHT command-line options.", 0));
#endif // QT_NO_TOOLTIP
