...
class Ui_AboutDialog
{
  public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About YCHT", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>YCHT</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2017 The Yacht developers", 0));
