...
class Ui_SignVerifyMessageDialog
{
      public:
        ...
        void setupUi(QDialog *SignVerifyMessageDialog)
        {
                ...
                signMessageButton_SM->setStyleSheet(QStringLiteral(""));
                QIcon icon3;
                ...
                clearButton_SM->setStyleSheet(QStringLiteral(""));
                QIcon icon4;
                ...
                verifyMessageButton_VM->setStyleSheet(QStringLiteral(""));
                QIcon icon5;
                ...
                clearButton_VM->setStyleSheet(QStringLiteral(""));
...
#ifndef QT_NO_TOOLTIP
                signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this YCHT address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
                verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified YCHT address", 0));
#endif // QT_NO_TOOLTIP
